...
\textls[-8]{De uma família nobre abastada, Turguêniev passou anos de sua vida na
...
\textls[-10]{``Primeira mágoa'' (\emph{Piervoie gorie}), de Lídia Avílova,
...
\textls[-10]{``A prova'' (\emph{Ekzámen}), que descreve a ansiedade de uma
...
\textls[-25]{O conto ``A pedrinha vermelha'' (\emph{Krásnyi kámechek}) foi impresso
...
\textls[-5]{\emph{Sobre como Kolka Pánkin viajou para o Brasil e sobre como Pietka
...
\noindent\textls[-12]{\textbf{Fido Nesti} é ilustrador e cartunista com trabalhos na \textit{Folha de S.Paulo} e \textit{The New Yorker}. Entre suas várias publicações, consta \textit{1984}, de George Orwell, que ilustrou e adaptou.}
