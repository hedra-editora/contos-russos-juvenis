\pagestyle{baruch}
\part[CATARINA II]{CATARINA II\partsub{(1729–1796)}}
...
\chapter{Conto do tsarévitche Cloro} \label{part1}
...
\textls[-13]{Antes dos tempos de Kii, príncipe de Kiev,\footnote{Kii, rei lendário,
  ...
  conforme a \emph{Narrativa dos tempos passados}.} vivia na Rússia um
...
cã desceu o morro e gritou três vezes ``hurra'', segurando com uma mão o tsarévitche, como uma galinha
...
\part[VLADÍMIR ODÓIEVSKI]{VLADÍMIR ODÓIEVSKI \partsub{(1804–1869)}}
...
\chapter{A cidadezinha na tabaqueira} \label{part2}

O pai colocou uma tabaqueira na mesa.

--- Venha cá, Micha, dê uma olhada --- disse ele.

\textls[-10]{Мicha era um menino obediente, no mesmo instante largou os brinquedos e
...
\textls[-10]{E o que aconteceu? De repente, não se sabe de onde, começou a soar uma
...
\textls[-10]{--- Sim, é verdade --- respondeu Micha ---, até agora não tinha me dado
...
\textls[-10]{--- Ah, não é verdade --- respondeu o guia ---, os sininhos não são
...
\part[IVAN TURGUÊNIEV]{IVAN TURGUÊNIEV \partsub{(1818–1883)}}
...
\textls[-10]{De todos os seus serviçais, o mais notável era o caseiro Guerássim, um
...
\textls[-10]{De volta ao seu quarto (ficava em um anexo, quase todo atravancado de
...
\textls[-10]{Tatiana, que desempenhava, como referido acima, a função de lavadeira
...
\textls[-5]{A artimanha não podia ter tido mais êxito. Ao ver Tatiana, no
...
\begin{figure}%[ht!]
\vspace*{-1.8cm}
\hspace*{-2.3cm}\includegraphics{./imgs/cena3.jpg}
\end{figure}
...
\textls[-10]{Guerássim virou"-se, avistou luzes e sombras tremeluzindo nas janelas e,
...
\textls[-15]{--- Liubóv Liubímovna --- começou com voz baixa e fraca; às vezes, ela
...
\textls[-20]{Erochka pegou o bastão e se sentou no último degrau da escada. A turba
...
\textls[-10]{Uma hora depois de todo esse alarde, a porta do cubículo se abriu e
...
\part[LEV TOLSTÓI]{LEV TOLSTÓI \partsub{(1828–1910)}}
...
\chapter[O prisioneiro do Cáucaso]{O prisioneiro do Cáucaso\subtitulo{(História verdadeira)}} \label{part4}
...
\textls[-20]{Jílin, à frente, se deteve e esperou a chegada do comboio. Ouviu um
...
Jílin percebeu que a coisa estava feia. A espingarda se foi e só com um
...
\textls[-15]{Jílin estava sentado atrás do tártaro, balançando e batendo o rosto nas
...
\textls[-10]{Viu uma estrada que descia a montanha; à direita, uma
...
\textls[-10]{O tártaro ruivo entrou, disse algo que parecia um xingamento e ficou ali
...
\textls[-10]{Saiu com o grilhão, claudicando de uma perna, e, sem conseguir pisar,
...
\textls[-10]{Quando os tártaros terminaram de comer, apareceu uma tártara vestindo
...
\textls[-10]{Um dia, houve uma tempestade forte, choveu a cântaros por uma hora.
...
\textls[-25]{As garotas levaram"-lhe retalhos e ele vestiu os bonecos: de mujique e de
...
\textls[-10]{O morto jazia na relva sem se mover, e eles estavam parados como mortos.
...
``Pois bem'', pensou ele, ``é preciso fugir agora'', e comunicou a
...
\textls[-10]{Partiram; assim que se puseram em movimento, ouviram o mulá cantando no
...
\textls[-10]{Ouviram vozes de tártaros, que tinham parado no lugar em que os oficiais
...
\textls[-20]{Depois de conversar, foram embora. De repente, Jílin ouviu um farfalhar em
...
Ergueu o olhar: as estrelas brilhavam alto no céu e, sobre o fosso,
...
\textls[-15]{Jílin agarrou a vara, mandou Dina segurá"-la e começou a escalar. Caiu
...
e ele não tinha chegado à margem do bosque. ``Pois bem'', pensou,
...
viera. Ele estava fora de si, apenas chorava e dizia:}
...
\part[NIKOLAI LESKÓV]{NIKOLAI LESKÓV \partsub{(1831–1895)}}
...
\textls[-20]{Quem deve ser considerado um bobo? Ao que parece, todo mundo sabe, mas,
...
\textls[-10]{Tínhamos empregado um administrador geral severo, muito severo, que
...
\textls[-15]{Os potros, nesse ano, tinham sido colocados sob guarda do menino
...
\textls[-20]{Em alguns anos, estourou a guerra da Crimeia\footnote{A Guerra da
...
\textls[-20]{Panka, que nessa época já tinha chegado à idade adulta, aproximou"-se sem
...
\textls[-10]{--- Sim --- disseram ---, riram no começo; daí, com os dois rublos que
...
\begin{figure}%[ht!]
\vspace*{-1.85cm}
\hspace*{-2.325cm}\includegraphics{./imgs/cena5.jpg}
\end{figure}
...
\textls[-20]{--- Como ``tarde demais''? A questão toda é a pessoa querer de verdade,
...
\textls[-30]{Os tártaros se apertaram em volta do cã. Ele disse baixinho:}
...
\part[АNTON TCHÉKHOV]{АNTON TCHÉKHOV \partsub{(1860–1904)}}
...
\textls[-25]{Agora, provavelmente, o avô estava no portão apertando os olhos para ver
...
\textls[-20]{Moscou é uma cidade grande. As casas são todas senhoriais e há uma
...
\textls[-10]{Vanka suspirou convulsivamente e voltou a fitar a janela. Lembrava que o
...
\textls[-10]{O avô arrastava o abeto cortado até a casa senhorial, onde se punham a
...
\textls[-10]{``Venha, vovô querido'', continuava Vanka, ``imploro ao Senhor Jesus
...
\textls[-25]{Vanka dobrou em quatro a folha rabiscada, colocando"-a no envelope que
comprara na véspera por um copeque\ldots{} Após pensar um pouco, umedeceu a
pena e escreveu o endereço:}

``Para a aldeia do vovô''.

\textls[-40]{Depois se coçou, pensou de novo e acrescentou: ``Konstantin Makárytch''.
Satisfeito por não ter sido impedido de escrever, colocou o gorro e saiu
correndo à rua em mangas de camisa\ldots{}}

\begin{figure}%[ht!]
\vspace*{-1.9cm}
\hspace*{-2.175cm}\includegraphics{./imgs/cena6.jpg}
\end{figure}

\textls[-20]{Os vendedores do açougue que ele interrogara na véspera disseram que as
...
\textls[-40]{Embalado por esperanças doces, dormiu profundamente uma hora depois\ldots{}
...
\textls[-15]{O homem acendeu um cigarro com boquilha de papel. Enquanto o
...
\textls[-20]{Pachka despiu"-se e não sem prazer começou a vestir o traje novo. Após
...
\textls[-20]{Passou muito tempo e mesmo assim o médico não apareceu. A cuidadora
...
\textls[-15]{O menino, sem distinguir as portas, precipitou"-se para a enfermaria da
...
\textls[-10]{A mancha vermelha e brilhante parecia assustadora na escuridão da noite,
...
\part[FIÓDOR SOLOGUB]{FIÓDOR SOLOGUB \partsub{(1863–1927)}}
...
\begin{figure}%[ht!]
\vspace*{-2.375cm}
\hspace*{-2.8cm}\includegraphics{./imgs/cena8.jpg}
\end{figure}
...
\textls[-10]{--- Um rico e bondoso comerciante de Bagdá de nome Khalis havia
...
\textls[-10]{Como se movido por uma força alheia, ele bateu na bochecha de Zoia. O
...
\part[LÍDIA AVÍLOVA]{LÍDIA AVÍLOVA \partsub{(1864–1943)}}
...
\chapter{Primeira mágoa} \label{part9}
...
\textls[-10]{--- Como não?! Ele mesmo fez a queixa. Como se eu tivesse tomado dele um
...
\textls[-25]{--- Por que está rindo? --- continuava Gricha, um pouco ofendido,
...
\textls[-15]{``Vai ver só!'', dizia consigo pensando na babá. ``Vou lhe dar uma
...
\part[ALEKSÁNDR KUPRIN]{ALEKSÁNDR KUPRIN \partsub{(1870–1938)}}
...
\chapter{O poodle branco} \label{part10}


\section{1}

\noindent{}\textls[-10]{Por veredas da costa montanhosa do sul da Crimeia, vagava de povoado em
...
\textls[-10]{O realejo era velho, sofria de rouquidão e acessos de tosse, tendo
...
\textls[-10]{--- Fazer o quê?\ldots{} É um órgão velho\ldots{} Sujeito a resfriados\ldots{} Mal
...
\textls[-10]{A vereda contornava um alto penhasco na costa, volteando à sombra de
...
\textls[-10]{--- Dois e cinco dão sete copeques\ldots{} Pois bem, Serioja, isso também é
...
\textls[-10]{Assim, o velho, o menino e o cão percorreram uma localidade inteira de
...
\textls[-30]{Na frente do terraço, havia um grande pátio de terra batida. Serguei
...
\textls[-20]{Um menino entre oito e dez anos, saindo de um dos quartos, lançou"-se no
...
\textls[-20]{A magrela de nariz vermelho arregalou os olhos de raiva, alguém começou
...
\textls[-15]{A agitação na varanda se acalmou. A senhora, o menino e o homem de
...
\textls[-15]{Sob o som rouco e engasgado do galope, Serguei esticou seu tapetinho no
...
\textls[-20]{--- Espere aí, meu caro --- o homem gordo de óculos dourados falou de
...
\textls[-20]{--- É algo bastante tolo da parte da sua dona! --- zangou"-se de repente
...
\textls[-20]{--- Só tenho uma coisa a lhe dizer, moço --- começou Martyn um tanto
...
\begin{figure}%[ht!]
\vspace*{-2.25cm}
\hspace*{-2.775cm}\includegraphics{./imgs/cena10.jpg}
\end{figure}
...
\textls[-10]{Ele tirou de um saco de tecido pão, uma dezena de tomates vermelhos, um
...
\textls[-15]{--- Em primeiro lugar, vou comprar um traje de acrobata para você:
...
\textls[-10]{O garoto não ouvia mais nada. Uma sonolência doce e terna tomou conta
...
\textls[-10]{Em silêncio chegaram até a cidade de Alupka. O velho gemeu e suspirou o
...
\textls[-10]{Depois de passar por uma mesquita branca com a cúpula verde em forma de
...
\textls[-10]{Serguei sentiu arrepios no meio desse silêncio majestoso, em que seus
...
\textls[-10]{O garoto atravessou silenciosamente uma cancela de madeira que conduzia
...
\textls[-10]{Ele não teve dificuldade para escalar os portões. As espirais de ferro
...
\textls[-15]{Serguei corria pelo estreito corredor formado, de um lado, pelo muro
...
\textls[-15]{Finalmente as forças o abandonaram. Aos poucos o pavor indômito deu
...
\textls[-10]{Fosse o caseiro menos habilidoso do que os dois amigos ou estivesse
...
\textls[-20]{Mas a menina não respondeu, fixando os olhos tristes no teto. Ela não
...
\textls[-10]{Quando a porta de seu quarto se abria para a sala e a da sala para o
...
\textls[-40]{--- Mas, olhe, Nádia --- apressou"-se o pai. --- A gente agora dará corda
...
\textls[-30]{--- Mas, compreenda, minha querida, isso é algo impossível! O elefante
...
\textls[-30]{--- Perdão --- começou o pai de Nádia. --- Será que o senhor deixaria
...
\textls[-10]{Coberto por uma manta branca, ele andava no meio da rua, todo pimpão,
...
\begin{figure}%[ht!]
\vspace*{-2.25cm}
\hspace*{-2.75cm}\includegraphics{./imgs/cena11.jpg}
\end{figure}
...
\textls[-30]{--- Não, senhorita, ele não tomou chá. Mas ele aceitaria com prazer água
...
\part[LÍDIA TCHÁRSKAIA]{LÍDIA TCHÁRSKAIA \partsub{(1875–1937)}}
...
\textls[-10]{Desde o momento em que, na cama larga, no lugar de um pai vivo, surgira
...
\begin{figure}%[ht!]
\vspace*{-2.3cm}
\hspace*{-2.8cm}\includegraphics{./imgs/cena13.jpg}
\end{figure}
...
\textls[-20]{Volódia discorda da mãe com a maior sinceridade. Por exemplo, por acaso
...
\textls[-20]{A pobre mãe ficaria trabalhando de novo até o amanhecer!}
...
\textls[-25]{--- Beba, minha querida, beba! --- dizia erguendo do travesseiro, com as
...
\textls[-30]{E as crianças já faziam planos para o esperado verão, agitadas,
...
\part[SACHA TCHÓRNY]{SACHA TCHÓRNY \partsub{(1880–1932)}}
...
\chapter{A pedrinha vermelha} \label{part14}
...
\textls[-10]{O menino chegou até a pequena bétula e sentou para descansar. ``Ficarei
...
--- Como vai lá? Amichka dorme no chão perto da minha cama --- assim que perceber você, ela morderá\ldots{}
...
\textls[-20]{--- Não é de nada, só come marmelada! Quem tem a lombriga na barriga é
...
\textls[-15]{Depois do almoço, Jórjik correu ao jardim para ver onde seu galo estava.
...
\textls[-20]{``Que raio é cracoviana?'', pensou Jórjik e de repente lembrou. ``É um tipo de dança\ldots{} Como é que as rãs dançam com quatro patas? Devem se
...
\textls[-20]{A mãe sorriu e trouxe leite para Jórjik. O leite, de tão gostoso, tinha
cheiro de pão com creme. A gata de novo veio correndo, começou a andar
por entre suas pernas e a cantar:}

\textls[-35]{--- Garoto com cara de biscoito, dê, miau, um pouco de leite!}
...
\textls[-10]{De manhã, assim que despertou, o menino enfiou a mão debaixo do
...
\part[DANIIL KHARMS]{DANIIL KHARMS \partsub{(1905–1942)}}
...
\markboth{Sobre como Kolka Pánkin viajou para o Brasil}{}
