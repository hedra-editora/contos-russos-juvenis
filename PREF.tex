...
\textls[-10]{A mando do próprio Pedro, que ocidentalizou a corte e obrigou todos os
...
\textls[-10]{Introduzindo a coletânea, o ``Conto do tsarévitche
...
\textls[-15]{Ainda no fim do século \textsc{xviii} surgiu aquele que foi o maior fabulista
russo, Ivan Krylóv (1769--1844), que adaptou muitas fábulas
...
\textls[-10]{Essas histórias coletadas ganharam refinamento literário nos poemas
...
\textls[-10]{A fase de grandes obras do realismo russo, consagrada mundialmente por
...
\textls[-10]{Belínski, que escreveu ``cerca de 200 trabalhos dedicados à literatura
...
\textls[-10]{Com a abolição da servidão em 19 de fevereiro (3 de março no calendário
...
\textls[-10]{O pedagogo Uchínski, valorizando a cultura popular, a língua russa, a
...
\textls[-15]{Ele criou em 1862 a revista mensal sobre pedagogia e educação
...
com linguagem concisa e procedimentos argutos) e fábulas
...
\textls[-15]{Dos autores russos do séc.\,\textsc{xix} conhecidos do leitor brasileiro, foi
Tolstói quem mais se dedicou à literatura infantojuvenil, mas outros
nomes consagrados também se interessaram por ela. Ivan Turguêniev gostava muito de crianças e chegou a planejar uma antologia de
...
\textls[-15]{Tchékhov não fazia diferença entre textos para adultos e para crianças,
...
\emph{Contos de Natal} do \emph{Jornal de Petersburgo}. No mesmo jornal
...
Avílova e o tinha como mestre. Numa carta de 1901,\footnote{\textls[-20]{\textsc{grómov},
  Mikhail, \emph{et al}. \emph{Correspondência de A. P. Tchékhov e A. I. Kuprin} (\emph{Peripiska A. P. Tchékhova i A. I. Kupriná}). Moscou:
...
\textls[-20]{O fim do século \textsc{xix} trouxe à arte russa o movimento simbolista e o
...
Aleksándr Blok, Ivan Búnin e Fiódor Sologub (\textsc{hellman}, p.\,215). Sob direção de
Natália Manasseina e Poliksiena Soloviova --- a Allegro, irmã do filósofo simbolista Vladímir Solovióv ---, a revista infantil \emph{Vereda} (1905--1912) também juntou muitos artistas importantes, principalmente simbolistas:
...
\textls[-20]{``A pedrinha vermelha'' foi um dos primeiros trabalhos infantis de Sacha
...
editor, na esfera infantil da futura União Soviética.}
...
ideologia, mas delineada --- enquanto o realismo socialista
ainda não havia se tornado estilo hegemônico --- por artistas não raro
dotados de linguagem arrojada.

\textls[-15]{Na literatura russa destinada aos adultos, experiências poéticas e
gráficas da vanguarda do início do século \textsc{xx} circulavam, em geral, em grupos restritos, ao passo que na literatura infantil eram
arregimentados escritores e artistas gráficos --- vindos de diversos
círculos que então proliferavam --- para a produção de livros
e revistas, impressos em tiragens consideráveis. Enquanto os órgãos soviéticos não incentivavam as criações para adultos
desses autores, aos seus livros infantis da década de 1920 eram
reservados recursos públicos vultosos (em meados da década seguinte, o
panorama mudou bastante). Muitos vanguardistas e
...
\tit{GOLOVIN}, Valentin. Primeira experiência de edição de uma revista para jovens na Rússia (\textit{Piérvyi opit izdania jurnala dlia iúnochestva v Rossia}). \textit{Konstruíruia diétskoie: filologuia, istoria, antropologuia}. Moscou, São Petersburgo: \textit{Azimut}, 2011.

\tit{GRÓMOV}, Mikhail, \textit{et al.} (org.) \textit{Correspondência de A. P. Tchékhov e A. I. Kuprin} (\textit{Peripiska A. P. Tchékhova i A. I. Kupriná}). Moscou: \textit{Khudójestvennaia literatura}, 1984.
...
\tit{KRAVTCHENKO}, Oksana. “Conto do tsarévitche Cloro” е o desenvolvimento do sistema alegórico e figurado na ode “Felícia” de G. R. Derjávin (\textit{“Skazka o tsariévitche Khlore” i púti razvitia eio óbrazno-allegorítcheskogo stroia v ode G. R. Derjávina “Felitsa”}). \textit{Imalologuia i komparativistka}, 2015, nº 1, pp. 91–104.

\tit{MOUNTIAN}, Daniela. A pedra viva de Mandelstam. \textit{Revista Rosa}, série 2, nº 1, 25 de maio de 2020. Disponível em: http:/revistarosa.com/1/a-pedra-viva-de-mandelstam/.

\tit{SIGÓV}, Vladímir (org.). \textit{Literatura infantil} (\textit{Diétskaia literatura}). Moscou: Iurait, 2019.

\tit{TURGUÊNIEV}, Ivan. Prefácio para \textit{Diário de menina} de S. Butkiévitch (\textit{Predislovie k “Dnevniku diévotchki” S. Butkiévitch}). \textit{Pólnoie sobránie sotchiniénii i pissem v 30 tomákh}. Moscou: \textit{Naúka}, 1982.

\tit{VÁSSINA}, Elena. Anton Pavlovitch Tchekhov. \textit{Revista Cult}. Disponível em: https:/revistacult.uol.com.br/home/anton-pavlovitch-tchekhov/.
