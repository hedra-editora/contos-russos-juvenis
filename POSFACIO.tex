...
\pagebreak
\noindent\textbf{VLADÍMIR ODÓIEVSKI}
...
Traduzido a partir de: \textsc{turguêniev}, I. \emph{Pólnoie sobránie sotchiniénii i pissem v 30
tomákh.} Moscou: \emph{Naúka,} 1980.

\bigskip
\noindent\textbf{LEV TOLSTÓI}
...
\bigskip
\noindent\textbf{ALEKSÁNDR KUPRIN}
...
\bigskip
\noindent\textbf{LÍDIA TCHÁRSKAIA}
...
\chapter{sobre os colaboradores} \label{part17}
...
\begin{center}
		...
		\centering\tiny\noindent{}Este livro foi impresso em junho de 2021 em papel Offset 90g/m. Tipologia: Big City Grotesque Pro. \begin{center}\normalsize\adforn{64}\end{center}
		\end{minipage}
\end{center}
